...
_start:
    ...
    ; Додамо обробку операцій множення та ділення
    ; Додамо нові дані
    section .data
        d db 2           ; Визначаємо d = 2
    section .text
    ; Множення
    mov al, [a]         ; Завантажуємо a в al
    mul byte [d]        ; Множимо al на d
    mov byte [a], al    ; Зберігаємо результат у a

    ; Ділення
    mov al, [a]         ; Завантажуємо a в al
    div byte [d]        ; Ділимо al на d
    mov byte [a], al    ; Зберігаємо результат у a
